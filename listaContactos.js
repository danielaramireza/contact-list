...
function buscarIDporNombreYApellido(nombreCompleto) {
  let persona = listaDeContactos.find(
    (contacto) => contacto.nombres + " " + contacto.apellidos === nombreCompleto
  );
  if (persona) {
    return persona.id;
  } else {
...
actualizarContacto("Carla Vargas Martinez", {
  nombres: "Carla Maria",
  telefono: 3108097644,
});

console.log(
  "Se actualizaron los nombres y telefono del contacto Carla Vargas Martinez"
);
imprimirListaContactos(["id", "nombres", "apellidos", "telefono"]);
